...
public class InternCoinTableActivityIISpecial extends BaseCoinTableActivity {
    ...
    protected int getLayoutId() {
        return R.layout.intern_coin_table_layout_ii_special;
    }

    @Override
    protected void setupButtonIDs() {
        buttonIDs = new int[][]{
                {R.id.Item00, R.id.Item01, R.id.Item02, R.id.Item03},
                ...
                {R.id.Item250, R.id.Item251, R.id.Item252, R.id.Item253}
        };
    }
    ...
    protected void setupDefaultTable() {
        ...
        // Init Table (4 columns)
        table = new TableItem[buttonIDs.length][4];
        // Header
        table[0] = new TableItem[]{II, CC1, CC2, CC3};
        // Body
    ...
    protected void goBack() {
        ...
        intent.putExtra("coinCountry", countryStringRaw); // Preserve the country intent
